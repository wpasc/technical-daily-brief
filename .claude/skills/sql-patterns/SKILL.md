...
name: sql-patterns
description: >-
  Day-to-day SQL query optimization, anti-patterns, ORM integration, and
  multi-dialect guidance.
  TRIGGER when: writing or optimizing SQL queries, working with ORMs,
  diagnosing slow queries, or handling multi-database compatibility.
  DO NOT TRIGGER when: designing database schemas from scratch (use
  database-design) or planning migrations (use migration-strategy).

...
description: >-
  Root-cause-first debugging methodology for any bug, test failure, or
  unexpected behavior.
  TRIGGER when: encountering a bug, test failure, deployment issue, or
  unexpected behavior -- before proposing any fixes.
  DO NOT TRIGGER when: the root cause is already known and confirmed
  with evidence.

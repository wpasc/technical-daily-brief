...
description: >-
  Red-green-refactor cycle for writing tests before implementation code.
  TRIGGER when: implementing any feature, bug fix, or behavior change
  that should have test coverage.
  DO NOT TRIGGER when: modifying configuration files, generated code,

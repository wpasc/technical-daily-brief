...
description: >-
  Dockerfile optimization, multi-stage builds, docker-compose best practices,
  and container security hardening.
  TRIGGER when: creating or modifying Dockerfiles, docker-compose files,
  or container deployment configurations.
  DO NOT TRIGGER when: working on application code that does not involve

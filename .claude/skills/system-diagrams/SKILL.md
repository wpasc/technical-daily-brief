...
description: Create evidence-backed diagrams for software engineering systems. TRIGGER when the user asks for architecture diagrams, request lifecycles, data flow, state transitions, decision logic, system maps, Mermaid diagrams, or visual explanations grounded in real code. DO NOT TRIGGER for ordinary prose explanations where a diagram would not clarify the system.
user-invocable: true
---

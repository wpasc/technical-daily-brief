...
description: >-
  Codex runtime skill generated from canonical `skills/devops-practices/SKILL.md`. CI/CD pipeline patterns, infrastructure-as-code guidance, and deployment strategies with rollback procedures.
---

# devops-practices (Codex Runtime Skill)

Canonical source: `skills/devops-practices/SKILL.md`

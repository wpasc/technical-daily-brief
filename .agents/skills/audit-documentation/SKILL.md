...
description: >-
  Codex runtime skill generated from canonical `skills/audit-documentation/SKILL.md`. Audit a repository's documentation against documentation-standards principles and check that docs and code cohere.
---

# audit-documentation (Codex Runtime Skill)

Canonical source: `skills/audit-documentation/SKILL.md`

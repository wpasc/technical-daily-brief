...
name: engage
description: >-
  Codex runtime skill generated from canonical `skills/engage/SKILL.md`. Adaptive task-context router backed by Linear that uses a sub-agent to evaluate the user's first work-style prompt against Linear Issues while preserving the main agent's context window.
---

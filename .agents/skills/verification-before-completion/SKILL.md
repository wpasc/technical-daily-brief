...
description: >-
  Codex runtime skill generated from canonical `skills/verification-before-completion/SKILL.md`. Require fresh verification evidence before claiming any task is complete, fixed, or passing.
---

# verification-before-completion (Codex Runtime Skill)

Canonical source: `skills/verification-before-completion/SKILL.md`

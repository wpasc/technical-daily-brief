...
| Documentation-only changes | No - edit docs directly or use documentation-specific guidance |
...
4. Identify AI guidance files in harness priority order (`AGENTS.md` for Codex,
   `CLAUDE.md` for Claude, then any referenced guidance or skills)

...
description: >-
  Codex runtime skill generated from canonical `skills/implement-feature/SKILL.md`. Phased feature implementation -- scout the codebase, clarify requirements, plan with per-step verification, implement test-first, review before handing back.
---

...
name: xray
description: >-
  Codex runtime skill generated from canonical `skills/xray/SKILL.md`. Instrument code paths with targeted logging to understand execution flow end-to-end.
---

# xray (Codex Runtime Skill)

Canonical source: `skills/xray/SKILL.md`
...
- Keep instrumentation temporary and clearly marked; pair cleanup with `xray-clean` rather than leaving traces behind.

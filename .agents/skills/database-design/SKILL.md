...
description: >-
  Codex runtime skill generated from canonical `skills/database-design/SKILL.md`. Schema design principles, index optimization, migration patterns, and performance tuning for relational databases.
---

# database-design (Codex Runtime Skill)

Canonical source: `skills/database-design/SKILL.md`

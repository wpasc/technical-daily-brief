...
description: >-
  Codex runtime skill generated from canonical `skills/audit-repository/SKILL.md`. Multi-vector repository health audit.
---

# audit-repository (Codex Runtime Skill)

Canonical source: `skills/audit-repository/SKILL.md`

...
name: xray-clean
description: >-
  Codex runtime skill generated from canonical `skills/xray-clean/SKILL.md`. Remove all x-ray instrumentation from the codebase.
---

# xray-clean (Codex Runtime Skill)

Canonical source: `skills/xray-clean/SKILL.md`
...
- Verify all instrumentation markers are removed before declaring cleanup complete.

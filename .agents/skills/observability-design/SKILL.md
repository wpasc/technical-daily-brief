...
description: >-
  Codex runtime skill generated from canonical `skills/observability-design/SKILL.md`. SLI/SLO frameworks, golden signals monitoring, alerting design, and dashboard principles for production systems.
---

# observability-design (Codex Runtime Skill)

Canonical source: `skills/observability-design/SKILL.md`

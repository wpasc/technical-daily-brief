...
description: >-
  Codex runtime skill generated from canonical `skills/data-pipeline-design/SKILL.md`. Architecture decision frameworks and patterns for data pipelines, modeling, orchestration, and data quality.
---

# data-pipeline-design (Codex Runtime Skill)

Canonical source: `skills/data-pipeline-design/SKILL.md`

...
description: >-
  Codex runtime skill generated from canonical `skills/dependency-audit/SKILL.md`. Dependency vulnerability scanning, supply chain risk assessment, bloat detection, and upgrade path analysis across multi-language manifests.
---

# dependency-audit (Codex Runtime Skill)

Canonical source: `skills/dependency-audit/SKILL.md`
